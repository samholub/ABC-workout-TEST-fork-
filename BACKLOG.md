...
| 7  | BLOCKED |         | Prefilled values need a clear signal that they're suggestions, but no extra tap. Sam: dim/placeholder style until edited or tapped-to-accept, or no prefill at all? |
