...
| 7  | DONE   | 03a07cf | Prefilled set values are logged untouched on tap: `startSession` seeds weight and reps from history, so tapping the check circle records numbers the user never entered or confirmed. |
